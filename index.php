      ...
      <section id="tab-iuran" class="tab-pane hidden space-y-4">
        ...
        <div class="bg-white rounded-2xl p-3 shadow-sm border border-slate-100 flex items-center justify-between">
          ...
          <div class="flex items-center gap-1.5">
            <button id="btnCaraBayar" onclick="App.openModal('modalCaraBayar')" class="px-3 py-1.5 bg-blue-900 text-white rounded-xl text-xs font-bold flex items-center gap-1 shadow-sm hover:bg-blue-950">
